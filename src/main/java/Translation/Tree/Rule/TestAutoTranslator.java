    ...
    public static void translateForBleu(String dataFolder, String pattern, String outputFile){
        ...
        try {
            for (int k = 0; k < 10; k++){
                ...
                AutomaticTranslationDictionary automaticTranslationDictionary = new AutomaticTranslationDictionary(toTrainTreeBank, ViewLayerType.ENGLISH_WORD, ViewLayerType.TURKISH_WORD, "tmpdictionary.xml");
